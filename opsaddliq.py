...
from codec.tasks.addliquity import add_liquidity_anyone
...
# beri coin
add_liquidity_anyone(j, router_add, "0xf97C453899fCAe9fc815460a223cF91FD1a0a6e1", 10, j.getAddr("TransactionManager"))
# USXXX
add_liquidity_anyone(j, router_add, "0x45F056BC4e2dEaE17135fE9B0F1EaC613422664b", 10, j.getAddr("TransactionManager"))
# GLD
add_liquidity_anyone(j, router_add, "0xFAbc5eC387125fAe130Bd86e91A29b58D3b74171", 10, j.getAddr("TransactionManager"))