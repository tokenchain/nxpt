...
var PriceOracleMetaData = &bind.MetaData{
	ABI: "[{\"inputs\":[{\"internalType\":\"address\",\"name\":\"token\",\"type\":\"address\"}],\"name\":\"getTokenPrice\",\"outputs\":[{\"internalType\":\"uint256\",\"name\":\"\",\"type\":\"uint256\"}],\"stateMutability\":\"view\",\"type\":\"function\"},{\"inputs\":[],\"name\":\"isPriceOracle\",\"outputs\":[{\"internalType\":\"bool\",\"name\":\"\",\"type\":\"bool\"}],\"stateMutability\":\"view\",\"type\":\"function\"}]",
}
...
func (_PriceOracle *PriceOracleCaller) GetTokenPrice(opts *bind.CallOpts, token common.Address) (*big.Int, error) {
	var out []interface{}
	err := _PriceOracle.contract.Call(opts, &out, "getTokenPrice", token)
...
//
// Solidity: function getTokenPrice(address token) view returns(uint256)
func (_PriceOracle *PriceOracleSession) GetTokenPrice(token common.Address) (*big.Int, error) {
	return _PriceOracle.Contract.GetTokenPrice(&_PriceOracle.CallOpts, token)
}

// GetTokenPrice is a free data retrieval call binding the contract method 0xd02641a0.
//
// Solidity: function getTokenPrice(address token) view returns(uint256)
func (_PriceOracle *PriceOracleCallerSession) GetTokenPrice(token common.Address) (*big.Int, error) {
	return _PriceOracle.Contract.GetTokenPrice(&_PriceOracle.CallOpts, token)
}
