"""Generated wrapper for FeeERC20 Solidity contract."""
...
# constructor for FeeERC20 below.
try:
    ...
    class FeeERC20Validator(  # type: ignore
        Validator
    ):
...
class FeeMethod(ContractMethod): # pylint: disable=invalid-name
    """Various interfaces to the fee method."""

    def __init__(self, elib: MiliDoS, contract_address: str, contract_function: ContractFunction, validator: Validator=None):
        """Persist instance data."""
        super().__init__(elib, contract_address)
        self._underlying_method = contract_function
        self.sign = validator.getSignature("fee")
    ...
    def block_send(self, _valeth:int=0) -> int:
        ...
        try:
            ...
            if 'data' in _t:
                ...
                self._on_receipt_handle("fee", tx_receipt, txHash)
            ...
            print(f"{Bolors.FAIL}Error {er} {Bolors.RESET}: fee")
            message = f"Error {er}: fee"
            self._on_fail("fee", message)
        except ValueError as err:
            if "message" in err.args[0]:
                message = err.args[0]["message"]
                print(f"{Bolors.FAIL}Error Revert {Bolors.RESET}, fee: {message}")
            else:
                message = "Error Revert , Reason: Unknown"
                print(f"{Bolors.FAIL}Error Revert {Bolors.RESET}, fee. Reason: Unknown")
...
class SetFeeMethod(ContractMethod): # pylint: disable=invalid-name
    """Various interfaces to the setFee method."""

    def __init__(self, elib: MiliDoS, contract_address: str, contract_function: ContractFunction, validator: Validator=None):
        """Persist instance data."""
        super().__init__(elib, contract_address, validator)
        self._underlying_method = contract_function
        self.sign = validator.getSignature("setFee")

    def validate_and_normalize_inputs(self, fee: int)->any:
        """Validate the inputs to the setFee method."""
        self.validator.assert_valid(
            method_name='setFee',
            parameter_name='_fee',
            argument_value=fee,
    ...
    def block_send(self, fee: int,_valeth:int=0) -> None:
        """Execute underlying contract method via eth_call.

        :param tx_params: transaction parameters
        :returns: the return value of the underlying method.
        """
        _fn = self._underlying_method(fee)
        try:
    ...
    def send_transaction(self, fee: int, tx_params: Optional[TxParams] = None) -> Union[HexBytes, bytes]:
        """Execute underlying contract method via eth_sendTransaction.

        :param tx_params: transaction parameters
        """
        (fee) = self.validate_and_normalize_inputs(fee)
        tx_params = super().normalize_tx_params(tx_params)
        return self._underlying_method(fee).transact(tx_params.as_dict())

    def build_transaction(self, fee: int, tx_params: Optional[TxParams] = None) -> dict:
        """Construct calldata to be used as input to the method."""
        (fee) = self.validate_and_normalize_inputs(fee)
        tx_params = super().normalize_tx_params(tx_params)
        return self._underlying_method(fee).buildTransaction(tx_params.as_dict())

    def estimate_gas(self, fee: int, tx_params: Optional[TxParams] = None) -> int:
        """Estimate gas consumption of method call."""
        (fee) = self.validate_and_normalize_inputs(fee)
        tx_params = super().normalize_tx_params(tx_params)
        return self._underlying_method(fee).estimateGas(tx_params.as_dict())
...
class TransferMethod(ContractMethod): # pylint: disable=invalid-name
    ...
    def block_send(self, account: str, amount: int,_valeth:int=0) -> bool:
        """Execute underlying contract method via eth_call.
...
class SignatureGenerator(Signatures):
    ...
    def fee(self) -> str:
        return self._function_signatures["fee"]
    ...
    def set_fee(self) -> str:
        return self._function_signatures["setFee"]
    def symbol(self) -> str:
...
class FeeERC20(ContractBase):
    """Wrapper class for FeeERC20 Solidity contract."""
    ...
    def __init__(
        ...
        validator: FeeERC20Validator = None,
    ):
        """Get an instance of wrapper for smart contract.
        """
        # pylint: disable=too-many-statements
        super().__init__(contract_address, FeeERC20.abi())
        web3 = core_lib.w3

        if not validator:
            validator = FeeERC20Validator(web3, contract_address)
        ...
        functions = self._web3_eth.contract(address=to_checksum_address(contract_address), abi=FeeERC20.abi()).functions
        self._signatures = SignatureGenerator(FeeERC20.abi())
        ...
        self._fn_fee = FeeMethod(core_lib, contract_address, functions.fee, validator)
        ...
        self._fn_set_fee = SetFeeMethod(core_lib, contract_address, functions.setFee, validator)
    ...
    def event_approval(
        ...
        """
        Implementation of event approval in contract FeeERC20
        Get log entry for Approval event.
                :param tx_hash: hash of transaction emitting Approval event
        """
        tx_receipt = self._web3_eth.getTransactionReceipt(tx_hash)
        return self._web3_eth.contract(address=to_checksum_address(self.contract_address), abi=FeeERC20.abi()).events.Approval().processReceipt(tx_receipt)
    ...
    def event_transfer(
        ...
        """
        Implementation of event transfer in contract FeeERC20
        Get log entry for Transfer event.
                :param tx_hash: hash of transaction emitting Transfer event
        """
        tx_receipt = self._web3_eth.getTransactionReceipt(tx_hash)
        return self._web3_eth.contract(address=to_checksum_address(self.contract_address), abi=FeeERC20.abi()).events.Transfer().processReceipt(tx_receipt)
    ...
    def allowance(self, owner: str, spender: str) -> int:
        """
        Implementation of allowance in contract FeeERC20
    ...
    def approve(self, spender: str, amount: int) -> bool:
        """
        Implementation of approve in contract FeeERC20
        Method of the function
    ...
    def balance_of(self, account: str) -> int:
        """
        Implementation of balance_of in contract FeeERC20
        Method of the function
    ...
    def burn(self, account: str, amount: int) -> None:
        """
        Implementation of burn in contract FeeERC20
        Method of the function
    ...
    def decimals(self) -> int:
        """
        Implementation of decimals in contract FeeERC20
        Method of the function
    ...
    def decrease_allowance(self, spender: str, subtracted_value: int) -> bool:
        """
        Implementation of decrease_allowance in contract FeeERC20
        Method of the function
    ...
    def fee(self) -> int:
        """
        Implementation of fee in contract FeeERC20
        Method of the function
    
        """
    
        self._fn_fee.callback_onfail = self._callback_onfail
        self._fn_fee.callback_onsuccess = self._callback_onsuccess
        self._fn_fee.auto_reciept = self.call_contract_enforce_tx_receipt
        self._fn_fee.gas_limit = self.call_contract_fee_amount
        self._fn_fee.gas_price_wei = self.call_contract_fee_price
        self._fn_fee.debug_method = self.call_contract_debug_flag
        ...
        return self._fn_fee.block_call()
    
    
    
    def increase_allowance(self, spender: str, added_value: int) -> bool:
        """
        Implementation of increase_allowance in contract FeeERC20
        Method of the function
    ...
    def mint(self, account: str, amount: int) -> None:
        """
        Implementation of mint in contract FeeERC20
        Method of the function
    ...
    def name(self) -> str:
        """
        Implementation of name in contract FeeERC20
        Method of the function
    ...
    def set_fee(self, fee: int) -> None:
        """
        Implementation of set_fee in contract FeeERC20
        Method of the function
        ...
        return self._fn_set_fee.block_send(fee)
    ...
    def symbol(self) -> str:
        """
        Implementation of symbol in contract FeeERC20
        Method of the function
    ...
    def total_supply(self) -> int:
        """
        Implementation of total_supply in contract FeeERC20
        Method of the function
    ...
    def transfer(self, account: str, amount: int) -> bool:
        """
        Implementation of transfer in contract FeeERC20
        Method of the function
        ...
        return self._fn_transfer.block_send(account, amount)
    ...
    def transfer_from(self, sender: str, recipient: str, amount: int) -> bool:
        """
        Implementation of transfer_from in contract FeeERC20
        Method of the function
    ...
    def CallContractWait(self, t_long:int)-> "FeeERC20":
